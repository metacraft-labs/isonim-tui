...
src-paths := "--path:src --path:tests --path:../isonim/src --path:../nim-termctl/src --path:../nim-faststreams --path:../nim-stew --path:../nim-everywhere/src"
